...
def parse_args():
    ...
    parser.add_argument('--config', help='train config file path',default='/home/txy/code/TXY_code/configs/config_castpose/castpose_config.py')
    parser.add_argument('--work-dir', help='the dir to save logs and models',
                        default='/home/txy/code/TXY_code/work_dirs/castpose'
                        )
    parser.add_argument(
        '--resume',
        nargs='?',
