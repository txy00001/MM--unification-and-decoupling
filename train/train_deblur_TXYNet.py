...
def parse_args():
    ...
    parser.add_argument('--config', default='/home/txy/code/TXY_code/configs/config_mmagic/deblur/txynet_1280×720.py')
    parser.add_argument('--work-dir', default='work_dirs/deblur_TXYNet')
    parser.add_argument(
