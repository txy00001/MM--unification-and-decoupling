...
def parse_args():
    ...
    parser.add_argument('--deploy_cfg', default='config_mmdeploy/mmseg/segmentation_onnxruntime_static-640x640.py')
    parser.add_argument('--model_cfg', default='configs/config_mmseg/qx_seg_config_2.py')
    parser.add_argument('--checkpoint', default='work_dirs/bubble_2/best_mIoU_iter_29500.pth')
    parser.add_argument('--img', default='pic/mmseg/894-640.png')
    parser.add_argument(
        '--test-img',
        default='/home/txy/code/TXY_code/pic/mmseg/1.png',
        type=str,
        nargs='+',
        help='image used to test model')
    parser.add_argument(
        '--work-dir',
        default="/home/txy/code/TXY_code/onnx/mmseg",
