...
from mmagic.models.editors.nafnet.naf_avgpool2d import Local_Base
...
@MODELS.register_module(name='NAFNet', force=True)
...
@MODELS.register_module(name='NAFNetLocal', force=True)
...
if __name__ == '__main__':
   ...
   net = NAFNet(img_channels=img_channels, mid_channels=mid_channels, enc_blk_nums=enc_blk_nums, dec_blk_nums=dec_blk_nums, middle_blk_num=middle_blk_num)
